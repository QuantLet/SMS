...
MVAclus8p, MVAclusfood, MVAclususcrime, MVAdrugsim, MVAspecclust, SMScarsim, 
SMSclus8km, SMSclus8p, SMSclus8pa, SMSclus8pc, SMSclus8pmst, SMSclus8pmst2, 
SMSclus8psc, SMSclusbank, SMSclusbank2, SMSclusbank3, SMScluscereal, SMScluscomp, 
SMScluscrime, SMScluscrimechi2, SMSclushealth, SMSclushealth05, SMScluskmcereal,
SMScluskmhealth'
...
example eight points and ward dendrogram'
```

![Picture1](SMSclus8pd-2.png)

![Picture2](SMSclus8pd.png)
...
set(H, 'LineWidth', 2)
title('Single Linkage Dendrogram - 8 points', 'FontSize', 16, 'FontWeight', 'Bold')
ylabel('Euclidean Distance', 'FontSize', 16, 'FontWeight', 'Bold')
box on
set(gca, 'LineWidth', 1.6, 'FontSize', 16, 'FontWeight', 'Bold')
```
